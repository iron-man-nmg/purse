        ...
        AutoGenerator mpg = new AutoGenerator()
                ...
                .setDataSource(
                        ...
                        new DataSourceConfig().setDbType(DbType.MYSQL)// 数据库类型
                                ...
                                }).setDriverName("com.mysql.jdbc.Driver").setUsername("root").setPassword("zhuoqidb@123")
                                .setUrl("jdbc:mysql://118.31.123.186:3306/timetravel?useUnicode=true&characterEncoding=UTF8&zeroDateTimeBehavior=convertToNull"))
                //.setDriverName("com.mysql.jdbc.Driver").setUsername("uatswan").setPassword("UATswan123!")
//                                .setUrl("jdbc:mysql://192.168.16.250:6606/swan?useUnicode=true&characterEncoding=utf-8"))
                .setStrategy(
                        // 策略配置
                        new StrategyConfig()
                                //是否使用@Data
                ...
                .setPackageInfoList(
                        new ArrayList<PackageConfig>() {{// 包配置
                            add(new PackageConfig().setModuleName("timetravel-gaea-dal.src.main.java")
                                    .setParent("com.zhuoqitech.timetravel.gaea")// 自定义包路径// 自定义包路径
                            ...
                            add(new PackageConfig().setModuleName("timetravel-gaea-dal.src.main.resources")
                            ...
                            if (isNeedService) {
                                ...
                                // 包配置
                                add(new PackageConfig().setModuleName("timetravel-gaea-service.src.main.java")
                                        .setParent("com.zhuoqitech.timetravel.gaea")// 自定义包路径// 自定义包路径
                            ...
                            if (isNeedController) {
                                ...
                                add(
                                        ...
                                        new PackageConfig().setModuleName("timetravel-gaea-webapp.src.main.java")
                                                .setParent("com.zhuoqitech.timetravel.gaea")// 自定义包路径// 自定义包路径
